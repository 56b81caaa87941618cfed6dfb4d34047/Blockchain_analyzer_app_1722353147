            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-200 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-900 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-black bg-purple-600 rounded-lg md:bg-transparent md:text-purple-600 md:p-0 md:dark:text-purple-400 hover:bg-purple-700 md:hover:bg-transparent md:hover:text-purple-700" aria-current="page">Home</a>
                        </li>
                        <li>
