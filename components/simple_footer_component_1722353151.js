        ...
        <nav class="bg-white shadow-md dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-purple-200 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-900 md:dark:bg-gray-900 dark:border-purple-700">
                        <li>
                        ...
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-black rounded-lg hover:bg-purple-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 md:dark:hover:text-purple-400 dark:text-purple-300 dark:hover:bg-purple-800 dark:hover:text-white md:dark:hover:bg-transparent dark:border-purple-700">About</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-black rounded-lg hover:bg-purple-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 md:dark:hover:text-purple-400 dark:text-purple-300 dark:hover:bg-purple-800 dark:hover:text-white md:dark:hover:bg-transparent dark:border-purple-700">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <footer id="footer-section" class="bg-white dark:bg-gray-900">
            <div id="footer-container" class="max-w-screen-xl p-8 py-12 mx-auto lg:py-16">
                ...
                <div class="flex justify-center">
                    <div id="footer-text" class="max-w-2xl text-base text-center text-black dark:text-gray-300">
